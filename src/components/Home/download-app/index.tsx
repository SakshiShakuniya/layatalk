...
const DownloadApp = () => {
  return (
    <section className='md:pt-44 sm:pt-24 pt-12 md:pb-32 pb-20 relative z-1 scroll-mt-32 md:scroll-mt-40 overflow-hidden' id='download-app'>
      <div className='container px-4'>
        <div className="bg-section/10 px-16 py-14 rounded-3xl border-2 border-section/20 grid grid-cols-12 items-center before:content-[''] before:absolute relative before:w-96 before:h-64 before:bg-start before:bg-no-repeat before:-bottom-11 overflow-hidden lg:before:right-48 before:-z-1 before:opacity-10 ">
          <div className='lg:col-span-8 col-span-12'>
            ...
            <p className='text-muted/60 text-18'>
              Join live voice rooms, meet new friends, and enjoy real-time
              <br /> conversations anytime, anywhere.
            </p>
          </div>
        ...
        <div className='pointer-events-none bg-linear-to-br from-tealGreen to-charcoalGray sm:w-50 w-96 sm:h-50 h-96 rounded-full sm:-bottom-40 -bottom-10 blur-400 z-0 absolute sm:-left-48 opacity-40'></div>
      </div>
    </section>
  )
}
