...
<head>
    ...
    <style>
        ...
        .btn { display: inline-flex; align-items: center; justify-content: center; min-width: 140px; padding: 12px 16px; border-radius: 10px; border: 1px solid #e879f9; color: #0a0112; background: #e879f9; text-decoration: none; margin-right: 12px; cursor: pointer; }
        .btn:hover { filter: brightness(1.05); }
        .card { background: #1a0524; padding: 16px; border-radius: 12px; border: 1px solid #3b0b4f; margin-top: 16px; }
        .stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 12px; margin: 16px 0; }
        .stat { background: #14041c; border: 1px solid #3b0b4f; border-radius: 12px; padding: 14px; }
        .stat .label { color: #b38abf; font-size: 12px; text-transform: uppercase; letter-spacing: .08em; }
