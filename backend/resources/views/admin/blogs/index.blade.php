...
<head>
    ...
    <style>
        ...
        .btn { display: inline-flex; align-items: center; justify-content: center; min-width: 140px; padding: 12px 16px; border-radius: 10px; border: 1px solid #e879f9; color: #0a0112; background: #e879f9; text-decoration: none; margin-right: 12px; cursor: pointer; line-height: 1; }
        .btn.small { min-width: auto; padding: 8px 12px; }
        .btn:hover { filter: brightness(1.05); }
        table { width: 100%; border-collapse: collapse; }
        th, td { border-bottom: 1px solid #3b0b4f; padding: 10px; text-align: left; }
        .empty { color: #b38abf; padding: 16px 4px; }
    </style>
</head>
<body>
    <div class="wrap">
